// Lighting
// TechniqueID: 0x3A26201
//
// Technique: 0Sh0_Vc_Spc_Shd_DfSh_Aspc_Snow_Aam_Parallax
  ...
  out float2 o3 : SV_Target3)
{
  ...
  if (r0.y != 0) {
    ...
    while (true) {
      ...
      r7.w = (int)r0.w;
      r9.xyz = cb2[r7.w+15].xyz + -v2.xyz;
      r8.w = dot(r9.xyz, r9.xyz);
      r9.w = sqrt(r8.w);
      r9.w = saturate(r9.w / cb2[r7.w+15].w);
      r9.w = -r9.w * r9.w + 1;
      r10.xyz = cb2[r7.w+22].xyz * r6.www;
      r6.w = rsqrt(r8.w);
      ...
      r8.xyz = r9.xyz * r9.www + r8.xyz;
      r7.xyz = r11.xyz * r9.www + r7.xyz;
      r0.w = 1 + r0.w;
    }
    r3.yzw = r7.xyz;
    r6.xyz = r8.xyz;
  ...
  o3.x = dot(r6.xyz, float3(0.300000,0.590000,0.110000));
