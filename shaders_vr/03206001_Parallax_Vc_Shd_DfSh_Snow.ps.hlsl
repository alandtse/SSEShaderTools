// ---- Created with 3Dmigoto v1.3.16 on Sun Jan 09 20:22:58 2022
  ...
  out float2 o3 : SV_Target3)
{
  ...
  if (r0.z != 0) {
    ...
    while (true) {
      ...
      if (r5.y != 0) {
        r5.y = (uint)r0.w;
        r5.y = dot(cb2[14].xyzw, icb[r5.y+0].xyzw);
        r5.y = min(3, r5.y);
        r5.y = (uint)r5.y;
        r5.y = dot(r7.xyzw, icb[r5.y+0].xyzw);
      } else {
        r5.y = 1;
      }
      r5.z = r1.x * r5.x + r0.w;
      ...
      r9.w = -r9.w * r9.w + 1;
      r11.xyz = cb2[r5.z+41].xyz * r5.yyy;
      r5.y = rsqrt(r8.w);
      r10.xyz = r10.xyz * r5.yyy;
      r5.y = saturate(dot(r6.xyz, r10.xyz));
