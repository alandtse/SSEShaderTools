// ---- Created with 3Dmigoto v1.3.16 on Sun Jan 09 20:25:14 2022
  ...
  out float2 o3 : SV_Target3)
{
  ...
  if (r0.z != 0) {
    ...
    while (true) {
      ...
      r0.w = r1.x * r5.x + r0.z;
      r0.w = (int)r0.w;
      r9.xyz = cb2[r0.w+27].xyz + -v2.xyz;
      r0.w = (int)r0.z;
      r5.y = dot(r9.xyz, r9.xyz);
      r5.z = sqrt(r5.y);
      r5.z = saturate(r5.z / cb2[r0.w+27].w);
      r5.z = -r5.z * r5.z + 1;
      r5.y = rsqrt(r5.y);
      r9.xyz = r9.xyz * r5.yyy;
      r5.y = saturate(dot(r6.xyz, r9.xyz));
      r9.xyz = cb2[r0.w+41].xyz * r5.yyy;
      r8.xyz = r9.xyz * r5.zzz + r8.xyz;
      r0.z = 1 + r0.z;
    }
    r7.xyz = r8.xyz;
  }
