// Lighting
// TechniqueID: 0x8024001
//
// Technique: 0Sh0_Vc_DfSh_Aspc_MTLand
  ...
  if (r3.w != 0) {
    ...
    while (true) {
      ...
      if (r2.w != 0) {
        ...
        r2.w = (uint)r2.w;
        r2.w = dot(r5.xyzw, icb[r2.w+0].xyzw);
      } else {
        r2.w = 1;
      }
      r3.z = (int)r1.w;
