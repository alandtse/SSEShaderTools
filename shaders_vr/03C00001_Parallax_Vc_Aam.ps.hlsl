// Lighting
// TechniqueID: 0x3C00001
//
// Technique: 0Sh0_Vc_Aam_Parallax
  ...
  out float4 o2 : SV_Target2)
{
  ...
  r0.y = TexProjectedNoiseSampler.Sample(ProjectedNoiseSampler, float2(1,1)).x;
  r0.y = cb1[14].z * r0.y;
  r0.y = max(0, r0.y);
  r0.y = min(cb1[14].w, r0.y);
  r0.xyz = r0.xxx * r0.yyy + r4.xyz;
  r3.w = 1;
