// ---- Created with 3Dmigoto v1.3.16 on Sun Jan 09 20:21:32 2022
  ...
  out float4 o2 : SV_Target2)
{
  ...
  r6.w = 1;
  r9.x = dot(cb2[23].xyzw, r6.xyzw);
  r9.y = dot(cb2[24].xyzw, r6.xyzw);
  r9.z = dot(cb2[25].xyzw, r6.xyzw);
  r0.yzw = cb2[16].yzw + r9.xyz;
  ...
  r0.x = saturate(dot(r6.xyz, r1.yzw));
  r0.x = 1 + -r0.x;
  r0.x = log2(r0.x);
  r0.x = cb2[26].w * r0.x;
  r0.x = exp2(r0.x);
  r6.w = 0.150000006;
  r1.x = saturate(dot(cb2[23].xyzw, r6.xyzw));
  r1.y = saturate(dot(cb2[24].xyzw, r6.xyzw));
  r1.z = saturate(dot(cb2[25].xyzw, r6.xyzw));
  r1.xyz = cb2[26].xyz * r1.xyz;
