// ---- Created with 3Dmigoto v1.3.16 on Sun Jan 09 20:25:44 2022
  ...
  out float4 o2 : SV_Target2)
{
  ...
  if (r0.w != 0) {
    ...
    while (true) {
      ...
      r7.w = r1.x * r0.z + r0.w;
      r7.w = (int)r7.w;
      r11.xyz = cb2[r7.w+27].xyz + -v2.xyz;
      r7.w = (int)r0.w;
      ...
      r8.w = saturate(dot(r6.xyz, r11.xyz));
      r12.xyz = cb2[r7.w+41].xyz * r8.www;
      ...
      r10.xyz = r11.xyz * r9.www + r10.xyz;
      r9.xyz = r12.xyz * r9.www + r9.xyz;
      r0.w = 1 + r0.w;
    }
    r7.xyz = r9.xyz;
    r8.xyz = r10.xyz;
  ...
  r0.z = cb1[14].y * r0.z;
  r0.z = r0.y * cb1[14].x + r0.z;
  r0.w = t11.Sample(s11_s, float2(1,1)).x;
  r0.w = cb1[14].z * r0.w;
  r0.w = max(0, r0.w);
  r0.w = min(cb1[14].w, r0.w);
  r1.xyz = r0.zzz * r0.www + r7.xyz;
  r6.w = 1;
  r7.x = dot(cb2[23].xyzw, r6.xyzw);
  r7.y = dot(cb2[24].xyzw, r6.xyzw);
  r7.z = dot(cb2[25].xyzw, r6.xyzw);
  r7.xyz = cb2[16].yzw + r7.xyz;
  ...
  r4.xyz = cb2[26].xyz * r4.xyz;
  r4.xyz = r4.xyz * r0.yyy;
  r2.xyz = r2.xyz * cb1[4].xyz + r4.xyz;
  ...
  r2.xyz = v11.xyz + -r1.xyz;
  r2.xyz = v11.www * r2.xyz + r1.xyz;
  r2.xyz = -r2.xyz * cb0[0].www + r1.xyz;
  r3.xyz = cb12[84].yyy * r2.xyz;
  r2.xyz = r2.xyz * cb12[84].yyy + cb0[1].zzz;
  r1.xyz = min(r2.xyz, r1.xyz);
  r0.yw = (uint2)v0.xy;
  bitmask.y = ((~(-1 << 2)) << 2) & 0xffffffff;  r0.y = (((uint)r0.y << 2) & bitmask.y) | ((uint)0 & ~bitmask.y);
  bitmask.y = ((~(-1 << 2)) << 0) & 0xffffffff;  r0.y = (((uint)r0.w << 0) & bitmask.y) | ((uint)r0.y & ~bitmask.y);
  r0.y = -icb[r0.y+0].x + cb2[15].z;
  r0.y = cmp(r0.y < 0);
  if (r0.y != 0) discard;
  o0.w = v10.w * r3.w;
  o0.xyz = -r3.xyz * cb12[84].zzz + r1.xyz;
