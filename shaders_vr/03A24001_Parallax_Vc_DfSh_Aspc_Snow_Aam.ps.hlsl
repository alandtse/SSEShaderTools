// ---- Created with 3Dmigoto v1.3.16 on Sun Jan 09 20:25:24 2022
  ...
  out float2 o3 : SV_Target3)
{
  ...
  if (r7.y != 0) {
    ...
    while (true) {
      ...
      if (r5.z != 0) {
        r5.z = (uint)r0.w;
        r5.z = dot(cb2[14].xyzw, icb[r5.z+0].xyzw);
        r5.z = min(3, r5.z);
        r5.z = (uint)r5.z;
        r5.z = dot(r8.xyzw, icb[r5.z+0].xyzw);
      } else {
        r5.z = 1;
      }
      r7.y = r1.x * r5.y + r0.w;
      r7.y = (int)r7.y;
      r10.xyz = cb2[r7.y+27].xyz + -v2.xyz;
      r7.y = (int)r0.w;
      r9.w = dot(r10.xyz, r10.xyz);
      r10.w = sqrt(r9.w);
      r10.w = saturate(r10.w / cb2[r7.y+27].w);
      r10.w = -r10.w * r10.w + 1;
      r11.xyz = cb2[r7.y+41].xyz * r5.zzz;
      r5.z = rsqrt(r9.w);
      r10.xyz = r10.xyz * r5.zzz;
      r5.z = saturate(dot(r6.xyz, r10.xyz));
  ...
  r3.xy = (uint2)v0.xy;
  bitmask.z = ((~(-1 << 2)) << 2) & 0xffffffff;  r0.z = (((uint)r3.x << 2) & bitmask.z) | ((uint)0 & ~bitmask.z);
  bitmask.z = ((~(-1 << 2)) << 0) & 0xffffffff;  r0.z = (((uint)r3.y << 0) & bitmask.z) | ((uint)r0.z & ~bitmask.z);
  r0.z = -icb[r0.z+4].x + cb2[15].z;
  r0.z = cmp(r0.z < 0);
  if (r0.z != 0) discard;
  o0.w = v10.w * r3.w;
