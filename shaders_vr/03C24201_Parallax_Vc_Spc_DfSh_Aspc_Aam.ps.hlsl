// ---- Created with 3Dmigoto v1.3.16 on Sun Jan 09 20:25:46 2022
  ...
  out float4 o2 : SV_Target2)
{
  ...
  r1.xy = cb12[86].xy * v0.xy;
  r0.w = t11.Sample(s11_s, r1.xy).x;
  r0.w = cb1[14].z * r0.w;
  r0.w = max(0, r0.w);
  r0.w = min(cb1[14].w, r0.w);
  r1.xyz = r0.zzz * r0.www + r7.xzw;
  r6.w = 1;
