// Lighting
// TechniqueID: 0x3804201
//
// Technique: 0Sh0_Vc_Spc_DfSh_Aam_Parallax
  ...
  out float4 o2 : SV_Target2)
{
  ...
  if (r4.y != 0) {
    ...
    while (true) {
      ...
      if (r4.y != 0) {
        r4.y = (uint)r2.z;
        r4.y = dot(cb2[2].xyzw, icb[r4.y+0].xyzw);
        r4.y = (uint)r4.y;
        r4.y = dot(r5.xyzw, icb[r4.y+0].xyzw);
      } else {
        r4.y = 1;
      }
      r6.w = (int)r2.z;
      ...
      r8.w = -r8.w * r8.w + 1;
      r10.xyz = cb2[r6.w+22].xyz * r4.yyy;
      r4.y = rsqrt(r7.w);
      r9.xyz = r9.xyz * r4.yyy;
      r4.y = saturate(dot(r3.xyz, r9.xyz));
      r11.xyz = r10.xyz * r4.yyy;
